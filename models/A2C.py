...
class A2C_Agent(object):
    ...
    def build_reward(self):
        with tf.name_scope('environment'):
            ...
            self.comb = self.avg_baseline + (1-self.gamma)*self.critic.predictions
            # self.advantage = self.reward - self.avg_baseline - self.critic.predictions
    ...
    def build_optimization(self):
        ...
        with tf.control_dependencies(update_ops):
            ...
            with tf.name_scope('reinforce'):
                ...
                # Discounted reward
                self.reward_baseline = tf.stop_gradient(self.reward - self.avg_baseline - (1-self.gamma)*self.critic.predictions)  # [Batch size, 1]
                ...
                self.loss1 -= self.lr1 * tf.reduce_mean(self.entropy_regularization, 0)
            ...
            with tf.name_scope('state_value'):
                ...
                self.loss2 = tf.losses.mean_squared_error((self.reward - self.avg_baseline)/(1-self.gamma), self.critic.predictions, weights=weights_)
