...
# net_arg.add_argument('--encoder_type', type=str, default='GATEncoder', help='type of encoder used')
# net_arg.add_argument('--encoder_type', type=str, default='SDGATEncoder', help='type of encoder used')
...
net_arg.add_argument('--num_heads', type=int, default=4, help='actor input embedding')
...
net_arg.add_argument('--num_gat_stacks', type=int, default=6, help='GAT num_neurons')
net_arg.add_argument('--residual', action='store_false', help='whether to use residual for gat encoder')
...
net_arg.add_argument('--use_bias', action='store_false', help='Whether to add bias term when calculating decoder logits')
...
net_arg.add_argument('--bias_initial_value', type=float, default=-10.,
                      help='Initial value for bias term when calculating decoder logits')
...
data_arg.add_argument('--max_length', type=int, default=11, help='number of variables')
# data_arg.add_argument('--max_length', type=int, default=10, help='number of variables')
# data_arg.add_argument('--data_size', type=int, default=5000, help='Number of observational samples')
# data_arg.add_argument('--data_size', type=int, default=3000, help='Number of observational samples')
# data_arg.add_argument('--max_length', type=int, default=11, help='number of variables')
data_arg.add_argument('--data_size', type=int, default=853, help='Number of observational samples')

data_arg.add_argument('--read_data', action="store_false", help='read existing_data or not')
...
# data_arg.add_argument('--normalize', action="store_false", help='whether the inputdata shall be normalized')
data_arg.add_argument('--transpose', action="store_false", help='whether the true graph needs transposed')

data_arg.add_argument('--score_type', type=str, default='BIC_different_var', help='score functions')
...
# data_arg.add_argument('--reg_type', type=str, default='QR', help='regressor type (in combination wth score_type)')
data_arg.add_argument('--reg_type', type=str, default='GPR', help='regressor type (in combination wth score_type)')
...
data_arg.add_argument('--lambda_flag_default', action="store_false",
...
# train_arg.add_argument('--agent_type', type=str, default='VPG', help='agent type')
# train_arg.add_argument('--agent_type', type=str, default='VPG_Replay', help='agent type')
# train_arg.add_argument('--agent_type', type=str, default='PPO1', help='agent type')
# train_arg.add_argument('--agent_type', type=str, default='PPORB', help='agent type')
# train_arg.add_argument('--agent_type', type=str, default='PPO2', help='agent type')
train_arg.add_argument('--agent_type', type=str, default='TRC', help='agent type')
# train_arg.add_argument('--agent_type', type=str, default='A2C', help='agent type')
...
train_arg.add_argument('--clip_ratio', type=float, default=0.1, help='clipping ratio')
train_arg.add_argument('--sigma', type=float, default=0.035, help='KL bound')
# Misc
